...
import { getLowcodeEventName, getReactEventProp } from '@lowcode/runtime';
import { getComponentEventConfig } from '@lowcode/runtime';
import type { ActionType, EventCategory, LowcodeAction, LowcodeEvents } from '@lowcode/runtime';
import { useComponentConfigStore } from '../../registry/component-registry-store';
import type { ComponentEvent as ComponentEventConfig } from '../../registry/component-registry-store';
...
export function ComponentEvent({ keyword = '' }: ComponentEventProps) {
    const { components, curComponent, updateComponentProps } = useComponentsStore((state) => ({
