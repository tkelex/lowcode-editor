...
import { ComponentSetter, useComponentConfigStore } from '../../registry/component-registry-store';
...
export function ComponentStyle({ keyword = '' }: ComponentStyleProps) {
  ...
  const { curComponentId, curComponent, updateComponentStyles } = useComponentsStore((state) => ({
