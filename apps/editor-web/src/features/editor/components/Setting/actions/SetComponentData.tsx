...
import type { SetComponentPropsAction, SetComponentStylesAction } from '@lowcode/runtime';
import { Component, getComponentById, useComponentsStore } from "../../../stores/editor-store";
