---
name: context-index
description: Generate and maintain concise project context indexes for future Codex sessions and other AI tools.
---
...
6. `AGENTS.md` — keep as a short operational entry and link to detailed context docs.
...
- Do not turn `AGENTS.md` into a huge context dump.
